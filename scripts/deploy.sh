...
aws lambda publish-layer-version --layer-name solar-moon-common --compatible-architectures arm64 --compatible-runtimes java17 java21 --description $version --region us-west-2 --content S3Bucket=solarmoonanalytics,S3Key=lambda/solar-moon-common.zip --output text
